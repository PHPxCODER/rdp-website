...
const RDPLogo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg
      version="1.1"
      id="Layer_1"
    ...
    >
      <style type="text/css">
        {`
          ...
          .st5{stroke:url(#SVGID_00000026142694711906432750000000235989762357459135_);stroke-linejoin:round;stroke-miterlimit:1.4142;}
      ...
      <g>
        <g>
          <g>
            <path className="st0" d="M113.8,223.8" />
            <path className="st0" d="M113.8,223.8L137,247l23.1-23.1c-15.4,0-30.8,0-46.1,0" />
            <path
              className="st0"
              d="M174.7,223.9c-4.9,0-9.7,0-14.6,0L137,247l23.2,23.2l30.4-30.4L174.7,223.9z"
            />
            <polygon
              id="XMLID_00000179615200077981023250000006815413956239915676_"
              className="st0"
              points="237,286.2 206.6,316.5 
            ...
            <rect
              x="165.4"
              y="250"
              transform="matrix(0.7075 -0.7068 0.7068 0.7075 -133.6954 210.0708)"
              className="st0"
              width="43"
              height="33"
            />
            <polygon
              id="XMLID_00000175283443617371105280000001027451038851223718_"
              className="st0"
              points="260,309.4 229.7,339.8 
				229.7,339.8 206.5,316.6 236.9,286.3"
            />
            <polyline
              id="XMLID_00000055703784353531135430000017810346190146760376_"
              className="st0"
              points="242,352 219.4,329.4 249.8,299.1 
				272.9,322.3 243.2,352"
            />
            <line
              id="XMLID_00000000219485317124035970000012773000331104895118_"
              className="st1"
              x1="242"
              y1="352"
              x2="242"
            ...
            />
            <polyline
              id="XMLID_00000155136698783768589690000006997538965894167714_"
              className="st0"
              points="289.5,352 296.1,345.4 302.7,352"
            />
            <polyline
              id="XMLID_00000131341046568374889840000014504242738291121068_"
              className="st0"
              points="243.2,352 272.9,322.2 
        ...
        <g id="XMLID_44_">
          <g id="XMLID_48_">
            <path
              id="XMLID_49_"
              className="st2"
              d="M174.6,223.9v-43.1c45.6,0,81-45.2,63.5-93.2c-6.4-17.6-20.7-31.9-38.4-38.3
          ...
          <polygon
            id="XMLID_47_"
            className="st0"
            points="174.8,181 131.8,181 131.8,138.1 131.8,138.1 174.8,138.1 174.8,138.1"
          />
          <polygon
            id="XMLID_46_"
            className="st0"
            points="131.8,213.9 99,213.9 99,213.9 99,181 131.8,181"
          />
          <path id="XMLID_45_" className="st0" d="M99,181H71.4l0,0v-27.6l0,0H99l0,0V181z" />
        </g>
        <polyline
          id="XMLID_00000088114756624215493180000005814937282167302803_"
          className="st0"
          points="63.7,237.1 63.7,223.8 106.6,223.8 
		106.6,259.8 63.7,259.8 63.7,259.8 63.7,237.1"
        />
        <polygon
          id="XMLID_00000157304017383464176080000010703593353938046379_"
          className="st0"
          points="106.6,293.6 63.7,293.6 63.7,293.6 
		63.7,258.6 106.6,258.6"
        />
        <polygon
          id="XMLID_00000043434601427797058790000004016416803691613062_"
          className="st0"
          points="106.6,352 63.7,352 63.7,352 
		63.7,320.9 106.6,320.9"
        />
        <polygon
          id="XMLID_00000139289533064436687410000003430336937326617751_"
          className="st0"
          points="106.6,325.2 63.7,325.2 63.7,325.2 
		63.7,291.5 106.6,291.5"
        />
        <g id="layer1" transform="translate(-21.475962,-178.535)">
          <g id="g1350" transform="matrix(1.0556855,0,0,1.0556855,-1.1958992,-9.9418072)">
            <path
              id="path3055"
              className="st2"
              d="M166.6,311c-0.4,0-0.6,0.1-1,0.3l-13.1,6.4c-0.6,0.4-1.1,1-1.4,1.8l-3.3,14.5
            ...
            <path
              id="path3059"
              className="st3"
              d="M166.7,315.9c-0.4,0-0.8,0.4-0.8,0.9l0,0c0,0.1,0,0.1,0,0.3c0,0.3,0.1,0.5,0.1,0.8
        ...
        <path
          className="st3"
          d="M124.8,196.5c-0.4-0.4-1.6-0.5-2.4-0.3c0-0.9-0.5-1.6-1.3-2.4l-0.3-0.3l-0.3,0.4c-0.4,0.6-0.5,1.5-0.5,2.3
          ...
          <g>
            <g>
              <g>
                ...
                <g style={{ clipPath: 'url(#SVGID_00000097478988827904617850000005050365955874508704_)' }}>
                  <circle className="st2" cx="85.1" cy="167.2" r="11" />

                  <linearGradient
                    id="SVGID_00000021833671149554230770000005224690222223216811_"
                  ...
                  >
                    ...
                    <stop offset="0.6094" style={{ stopColor: '#FFFFFF', stopOpacity: 0.57 }} />
                    <stop offset="0.7969" style={{ stopColor: '#FFFFFF', stopOpacity: 0 }} />
                    <stop offset="1" style={{ stopColor: '#FFFFFF', stopOpacity: 0 }} />
                  </linearGradient>

                  <path
                    style={{
                      stroke: 'url(#SVGID_00000021833671149554230770000005224690222223216811_)',
                  ...
                  <linearGradient
                    id="SVGID_00000054244392213309070060000013523146997252277893_"
                    gradientUnits="userSpaceOnUse"
                    x1="84.8197"
                    y1="-26.4734"
                    x2="90.2188"
                  ...
                  <path
                    style={{
                      fillRule: 'evenodd',
                      clipRule: 'evenodd',
                      fill: 'url(#SVGID_00000054244392213309070060000013523146997252277893_)',
                    }}
                    d="M82.2,162.8L82.2,162.8h-1.9v8.9h1.9v-6l9.4,11.6c0.5-0.4,1-0.8,1.5-1.1L82.2,162.8L82.2,162.8z"
                  />
                </g>
              </g>
            </g>
        ...
        <line
          id="XMLID_00000073698410318387069950000018113614955953366442_"
          className="st1"
          x1="242"
          y1="352"
          x2="302.7"
